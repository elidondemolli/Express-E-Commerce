<template>
    <div>
        <section class="wrapper container">
            ...
            <form method="POST" enctype="multipart/form-data" class="form" @submit.prevent="submitForm" >
                ...
                <div class="input_field">
                    <label>Content</label>
                    <input type="text" class="input" name="content" v-model="post.content">
                </div>
                <div class="input_field">
                    <label>Image</label>
                    <input type="file" id="file" ref="file" @change="selectFile" class="input" name="image"> 
                </div>
                <div class="input_field">
                    <label>Rating</label>
                ...
                <div class="input_field">
                    ...
                    <input type="text" class="input" name="category" v-model="post.category">
                </div>
                <div class="input_field">
                    <label>Price</label>
